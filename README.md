...
```text
WindowsTray/src-tauri/target/release/bundle/nsis/Codex Quota Viewer_0.0.5_x64-setup.exe
WindowsTray/src-tauri/target/release/bundle/msi/Codex Quota Viewer_0.0.5_x64_en-US.msi
```
